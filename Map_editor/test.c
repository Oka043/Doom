...
#define hfov (0.70f*W)  // Affects the horizontal field of vision
#define vfov (.2f*W)    // Affects the vertical field of vision
...
{
    FILE* fp = fopen("map-clear.c", "rt");
    if(!fp) { perror("map-clear.c"); exit(1); }
